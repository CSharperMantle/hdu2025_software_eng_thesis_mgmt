      ...
      <template #item.1>
        <div class="pa-4">
          ...
          <div v-else class="text-grey">
            您还未选择课题，请前往选题页面选择课题
            <v-btn class="mt-2" color="primary" to="/student/select">
              前往选题
            </v-btn>
          </div>
        </div>
      ...
      <template #item.2>
        <div class="pa-4">
          ...
          <div v-if="initialReport">
            <v-chip class="mb-2" :color="getProgressOutcomeColor(initialReport.prog_report_outcome)">
            ...
            <div class="text-caption text-grey mb-2">提交时间: {{ formatDateTime(initialReport.prog_report_time)
            }}</div>
      ...
      <template #item.3>
        <div class="pa-4">
          ...
          <div v-if="midtermReport">
            <v-chip class="mb-2" :color="getProgressOutcomeColor(midtermReport.prog_report_outcome)">
            ...
            <div class="text-caption text-grey mb-2">提交时间: {{ formatDateTime(midtermReport.prog_report_time)
            }}</div>
            <div class="d-flex justify-space-between">
              <v-btn
      ...
      <template #item.4>
        <div class="pa-4">
          ...
          <div v-if="finalDefense">
            ...
            <div class="text-caption text-grey mb-2">提交时间: {{ formatDateTime(finalDefense.final_def_time) }}
            </div>
            <v-btn
