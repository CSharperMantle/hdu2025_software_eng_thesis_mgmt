<template>
              ...
              <div class="pa-4">
                ...
                <div v-if="report.initial">
                  ...
                  <div class="mb-2">
                    ...
                    <div class="text-body-2">{{ formatDateTime(report.initial.prog_report_time) }}</div>
                  </div>
                  ...
                  <div class="d-flex justify-space-between mt-2">
                    <v-btn
                      ...
                      color="info"
                      @click="downloadAttachment(report.initial.prog_report_attachment, `${report.student_name}_开题报告`)"
                    >
            ...
            <template #item.3>
              <div class="pa-4">
                ...
                <div v-if="report.midterm">
                  ...
                  <div class="mb-2">
                    <div class="text-subtitle-2 text-grey mb-1">提交时间:</div>
                    <div class="text-body-2">{{ formatDateTime(report.midterm.prog_report_time) }}</div>
                  </div>
                  ...
                  <div class="d-flex justify-space-between mt-2">
                    <v-btn
                      ...
                      color="info"
                      @click="downloadAttachment(report.midterm.prog_report_attachment, `${report.student_name}_中期检查`)"
                    >
                      <v-icon start>mdi-download</v-icon>
                      下载附件
                    </v-btn>
            ...
            <template #item.4>
              <div class="pa-4">
                ...
                <div v-if="report.defense">
                  ...
                  <div class="mb-2">
                    <div class="text-subtitle-2 text-grey mb-1">提交时间:</div>
                    <div class="text-body-2">{{ formatDateTime(report.defense.final_def_time) }}</div>
                  </div>
  ...
  <v-dialog v-model="reviewDialogVisible" max-width="600">
    <v-card v-if="selectedReport">
      ...
      <v-card-actions>
        <v-spacer />
        <v-btn color="grey" variant="text" @click="reviewDialogVisible = false">
          取消
        </v-btn>
