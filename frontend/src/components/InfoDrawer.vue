<template>
  ...
  <v-dialog v-model="userInfoDialogVisible" max-width="600">
    <v-card>
      ...
      <v-card-actions>
        <v-spacer />
        <v-btn color="grey" variant="text" @click="userInfoDialogVisible = false"> 取消 </v-btn>
  ...
  <v-dialog v-model="passwordDialogVisible" max-width="600">
    <v-card>
      ...
      <v-card-actions>
        <v-spacer />
        <v-btn color="grey" variant="text" @click="passwordDialogVisible = false"> 取消 </v-btn>
        <v-btn color="primary" @click="savePassword"> 保存 </v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
